...
import {Match,EMPTY_INPUT} from '../game.ts';
import {cleanInput,snapshot,applySnapshot} from '../network-state.ts';
import {directionTargets} from '../direction-alerts.ts';
import {TAUNTS,tauntGain,tauntSector} from './taunts.ts';
...
console.log('Passed: 7 sectors, cancellation, input validation, distance/floor attenuation, remote actor playback, cooldown, hearing range, death restriction and snapshot alerts.');
